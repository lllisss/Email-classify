...
tf.flags.DEFINE_string("positive_data_file", "./data/ham_1000.utf8", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/spam_1000.utf8", "Data source for the negative data.")
tf.flags.DEFINE_string("new_data_file", "./data/test5.utf8", "Data source for the negative data.")
...
# Load data
print("Loading data...")
x_text, y = data_helpers.load_positive_negative_data_files(FLAGS.positive_data_file, FLAGS.negative_data_file,FLAGS.new_data_file)
